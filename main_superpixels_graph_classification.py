...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    logger.set_names(['Epoch', 'Train loss', 'Val. loss', 'Test loss', 'Train acc', 'Val acc', 'Test acc'])
    ...
    try:
        with tqdm(range(params['epochs'])) as t:
            for epoch in t:
                ...
                logger.append([epoch,epoch_train_loss, epoch_val_loss, epoch_train_acc, epoch_val_acc, epoch_test_acc, optimizer.param_groups[0]['lr'] ])
    ...
    logger.add(['Test Acc', test_acc])
    logger.add(['Train Acc', train_acc])
...
def main():    
    ...
    mylog = args.dataset + '-' + MODEL_NAME + '-' + args.seed + '-log.txt'
    dirs = root_log_dir, root_ckpt_dir, write_file_name, write_config_file, mylog
