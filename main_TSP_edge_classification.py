...
def train_val_pipeline(MODEL_NAME, dataset, params, net_params, dirs):
    ...
    try:
        with tqdm(range(params['epochs'])) as t:
            for epoch in t:
                ...
                logger.append([epoch, epoch_train_loss, epoch_val_loss, epoch_train_f1, epoch_val_f1, epoch_test_f1, optimizer.param_groups[0]['lr'] ])
    ...
    logger.add(['Test Acc', test_f1])
    logger.add(['Train Acc', train_f1])
