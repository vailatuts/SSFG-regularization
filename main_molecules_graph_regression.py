    ...
    try:
        with tqdm(range(params['epochs'])) as t:
            for epoch in t:
                ...
                logger.append([epoch,epoch_train_loss, epoch_val_loss, epoch_train_mae, epoch_val_mae, epoch_test_mae, optimizer.param_groups[0]['lr'] ])
...
def main():    
    ...
    mylog = 'Zink' + '-' + MODEL_NAME + '-' + args.seed + '-log.txt'
